...
Given the high p-values(>0.05) for all racial groups in Democrats and Republicans, we are unable to construct multiple linear regressions. Instead, we decided to cluster the data to....
## Recommendations 
